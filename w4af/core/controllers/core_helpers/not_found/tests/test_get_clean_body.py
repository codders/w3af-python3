...
class TestGetCleanBody(unittest.TestCase):
    ...
    def test_get_clean_body_14955(self):
        ...
        """
        url = URL('https://w4af.readthedocs.io/.git/.git/.git/index')
        headers = Headers([('Content-Type', 'text/html')])

        body = ('<head><title>Document Moved</title></head>'
                '<body><h1>Object Moved</h1>This document may be found '
                '<a HREF="https://w4af.readthedocs.io/.git/.git/.git/index/">here</a></body>')
    ...
    def test_get_clean_body_14956(self):
        ...
        """
        url = URL('https://w4af.readthedocs.io/install.php?mode=phpinfo')
        headers = Headers([('Content-Type', 'text/html')])
        ...
        body = ('<head><title>Document Moved</title></head>'
                '<body><h1>Object Moved</h1>This document may be found '
                '<a HREF="https://w4af.readthedocs.io/install.php?mode=phpinfo">here</a></body>')
