...
class TestUpdateURLs(unittest.TestCase):
    ...
    def test_basic(self):
        u1 = URL('https://w4af.readthedocs.io/')
        r1 = FuzzableRequest(u1, method='GET')
        kb.kb.add_fuzzable_request(r1)
        result = kb.kb.get_all_known_urls()
        self.assertEqual(len(result), 1)
        self.assertEqual("https://w4af.readthedocs.io/", list(result)[0].url_string)

        u2 = URL('https://w4af.readthedocs.io/blog/')
        r2 = FuzzableRequest(u2, method='GET')
        u3 = URL('https://w4af.readthedocs.io/')
        ...
        expected_set = set(["https://w4af.readthedocs.io/", "https://w4af.readthedocs.io/blog/"])
