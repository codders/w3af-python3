...
class TestDiskSet(unittest.TestCase):
    ...
    def test_add_urlobject(self):
        ...
        ds.add(URL('https://w4af.readthedocs.io/?id=2'))
        ds.add(URL('https://w4af.readthedocs.io/?id=3'))
        ds.add(URL('https://w4af.readthedocs.io/?id=3'))

        self.assertEqual(ds[0], URL('https://w4af.readthedocs.io/?id=2'))
        self.assertEqual(ds[1], URL('https://w4af.readthedocs.io/?id=3'))
        self.assertEqual(len(ds), 2)
        self.assertFalse(URL('https://w4af.readthedocs.io/?id=4') in ds)
        self.assertTrue(URL('https://w4af.readthedocs.io/?id=2') in ds)

    def test_add_QsRequest(self):
        ds = DiskSet()

        uri = URL('https://w4af.readthedocs.io/?id=2')
        hdr = Headers([('Referer', 'https://w4af.readthedocs.io/')])

        qsr1 = FuzzableRequest(uri, method='GET', headers=hdr)

        uri = URL('https://w4af.readthedocs.io/?id=3')
        qsr2 = FuzzableRequest(uri, method='GET', headers=hdr)

        uri = URL('https://w4af.readthedocs.io/?id=7')
