...
class TestDiskList(unittest.TestCase):
    ...
    def test_urlobject(self):
        ...
        dl.append(URL('https://w4af.readthedocs.io/?id=2'))
        dl.append(URL('https://w4af.readthedocs.io/?id=3'))

        self.assertEqual(dl[0], URL('https://w4af.readthedocs.io/?id=2'))
        self.assertEqual(dl[1], URL('https://w4af.readthedocs.io/?id=3'))
        self.assertNotIn(URL('https://w4af.readthedocs.io/?id=4'), dl)
        self.assertIn(URL('https://w4af.readthedocs.io/?id=2'), dl)
    ...
    def test_fuzzable_request(self):
        ...
        qsr1 = FuzzableRequest(uri, method='GET', headers=Headers(
            [('Referer', 'https://w4af.readthedocs.io/')]))
