...
class TestURLTree(unittest.TestCase):
    ...
    def test_root(self):
        ...
        expected = {URLNode('https://w4af.readthedocs.io', 1): {}}
        self.assertEqual(tree.tree, expected)

    def test_two_independent_paths(self):
        tree = URLTree()

        url_1 = URL('https://w4af.readthedocs.io/foo/')
        url_2 = URL('https://w4af.readthedocs.io/bar/')
        tree.add_url(url_1)
        tree.add_url(url_2)

        expected = {URLNode("https://w4af.readthedocs.io", 0): {URLNode("foo", 1): {},
                                                    URLNode("bar", 1): {}}}
        self.assertEqual(tree.tree, expected)
    ...
    def test_two_nested_paths(self):
        ...
        url_1 = URL('https://w4af.readthedocs.io/foo/bar/')
        url_2 = URL('https://w4af.readthedocs.io/spam/eggs/')
        tree.add_url(url_1)
        tree.add_url(url_2)

        expected = {URLNode("https://w4af.readthedocs.io", 0):
    ...
    def test_nested_paths_and_files(self):
        ...
        url_1 = URL('https://w4af.readthedocs.io/foo/bar/')
        url_2 = URL('https://w4af.readthedocs.io/spam/eggs/123.txt')
        tree.add_url(url_1)
        tree.add_url(url_2)
