...
class TestURLRegex(unittest.TestCase):
    def test_simple_domain(self):
        matches = URL_RE.findall('https://w4af.readthedocs.io/')
        self.assertEqual(matches[0][0], 'https://w4af.readthedocs.io/')
    ...
    def test_simple_domain_padding(self):
        matches = URL_RE.findall('123 https://w4af.readthedocs.io/ 456')
        self.assertEqual(matches[0][0], 'https://w4af.readthedocs.io/')

    def test_domain_filename_padding(self):
        matches = URL_RE.findall('123 https://w4af.readthedocs.io/scanner 456')
        self.assertEqual(matches[0][0], 'https://w4af.readthedocs.io/scanner')

    def test_domain_filename_query_string_padding(self):
        matches = URL_RE.findall('123 https://w4af.readthedocs.io/scanner?id=1 456')
        self.assertEqual(matches[0][0], 'https://w4af.readthedocs.io/scanner?id=1')

    def test_domain_filename_query_string_multiple_params_padding(self):
        matches = URL_RE.findall('123 https://w4af.readthedocs.io/scanner?id=1&foo=bar 456')
        self.assertEqual(matches[0][0], 'https://w4af.readthedocs.io/scanner?id=1&foo=bar')
