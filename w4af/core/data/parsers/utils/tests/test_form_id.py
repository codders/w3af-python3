...
class TestFormID(unittest.TestCase):
    HOSTED_AT_URL = URL('https://w4af.readthedocs.io/products/product-132')
    ACTION_URL = URL('https://w4af.readthedocs.io/products/comments')
    ...
    def test_not_match_hosted_at_regex(self):
        user_configured_json = {'hosted_at_url': '/products/.*'}
        form_matcher = self.create_form_matcher(user_configured_json)
        found_form_id = FormID(hosted_at_url=URL('https://w4af.readthedocs.io/another/product-132'),
                               inputs=['comment', 'submit'])
    ...
    def test_matches_one_of_false_2(self):
        ...
        found_form_id = FormID(action=URL('https://w4af.readthedocs.io/products/product-132'),
                               inputs=['comment', 'submit'],
                               hosted_at_url=self.HOSTED_AT_URL,
                               method='post',
                               attributes={'class': 'comment-css'})
