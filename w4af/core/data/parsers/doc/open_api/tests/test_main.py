...
class TestOpenAPIMain(unittest.TestCase):
    ...
    def test_real_api_yaml(self):
        ...
        e_api_calls = [('GET',
                        'https://w4af.readthedocs.io/bankid/tokens/4271a25e-7211-4306-b527-46196eb2af28',
                        Headers([('Content-Type', 'application/json')]),
                        ''),
                       ('POST',
                        'https://w4af.readthedocs.io/bankid/tokens',
                        Headers([('Content-Type', 'application/json')]),
                        '{"body": null}'),
                       ('POST',
                        'https://w4af.readthedocs.io/bankid/tokens',
                       ...
                       ('POST',
                        'https://w4af.readthedocs.io/bankid/orders',
                        Headers([('Content-Type', 'application/json')]),
                        '{"body": null}'),
                       ('POST',
                        'https://w4af.readthedocs.io/bankid/orders',
                       ...
                       ('GET',
                        'https://w4af.readthedocs.io/persons/3419/partners',
                        Headers([('Content-Type', 'application/json')]),
                        ''),
                       ('GET',
                        'https://w4af.readthedocs.io/persons/3419/partners',
                        ...
                        ''),
                       ('GET',
                        'https://w4af.readthedocs.io/persons/3419/partners/3419',
                        Headers([('Content-Type', 'application/json')]),
                        ''),
                       ('GET',
                        'https://w4af.readthedocs.io/persons/3419/partners/3419',
                        ...
                        ''),
                       ('GET',
                        'https://w4af.readthedocs.io/persons/3419',
                        Headers([('Content-Type', 'application/json')]),
                        ''),
                       ('GET',
                        'https://w4af.readthedocs.io/persons/3419',
                       ...
                       ('PUT',
                        ...
                        '{"body": {"partner": "19101010****", "termsAccepted": false}}'),
                       ('POST',
                        'https://w4af.readthedocs.io/events',
                        Headers([('Content-Type', 'application/json')]),
                        '{"body": null}'),
                       ('POST',
                        'https://w4af.readthedocs.io/events',
