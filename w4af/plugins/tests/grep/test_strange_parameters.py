...
class TestStrangeParameters(unittest.TestCase):
    ...
    def test_strange_parameters_sent_false_positive_01(self):
        body = ('<link rel="amphtml" href="https://w4af.readthedocs.io/?searchsubmit='
                'S%C3%B6k&#038;s=echo+str_repeat%28%27ruvkt%27%2C5%29%3B&#038;amp">')

        url = URL('https://w4af.readthedocs.io/?searchsubmit=S%C3%B6k&s=echo%20str_repeat%28%27ruvkt%27%2C5%29%3B')
