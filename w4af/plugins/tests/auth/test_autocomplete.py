...
class LoginMockResponse(MockResponse):
    def get_response(self, http_request, uri, response_headers):
        ...
        response_headers['Location'] = 'https://w4af.readthedocs.io/admin'
...
class SessionCheckMockResponse(MockResponse):
    def get_response(self, http_request, uri, response_headers):
        ...
        response_headers['Location'] = 'https://w4af.readthedocs.io/unittest'
        response_headers['status'] = 302
...
class TestAutocomplete(PluginTest):
    ...
    MOCK_RESPONSES = [
                      MockResponse('https://w4af.readthedocs.io/login_form.py',
                                   HTML_LOGIN_FORM,
                                   status=200,
                                   method='GET',
                                   headers={'Set-Cookie': '__csrf=09876xyzxyz'}),

                      LoginMockResponse('https://w4af.readthedocs.io/login_post.py',
                                        '',
                                        method='POST'),

                      SessionCheckMockResponse('https://w4af.readthedocs.io/admin', ''),

                      MockResponse('https://w4af.readthedocs.io/unittest',
                                   'Success',
                                   status=200,
                                   method='GET')
                      ]
...
class TestAutocompleteInvalidCredentials(PluginTest):
    ...
    def test_handle_invalid_credentials(self):
        ...
        expected_desc = (
            ...
            ' - Login form with action https://w4af.readthedocs.io/login_post.py found in HTTP response with ID 21\n'
            ' - Login form sent to https://w4af.readthedocs.io/login_post.py in HTTP request ID 22\n'
