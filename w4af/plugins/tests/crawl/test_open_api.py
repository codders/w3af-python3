...
class TestOpenAPIFindAllEndpointsWithAuth(PluginTest):
    ...
    MOCK_RESPONSES = [MockResponse('https://w4af.readthedocs.io/',
                                   body='',
                                   method='GET',
                                   status=200),
                      MockResponse('https://w4af.readthedocs.io/swagger.json?api_key=%s' % API_KEY,
    ...
    def test_find_all_endpoints_with_auth(self):
        ...
        e_url = 'https://w4af.readthedocs.io/api/pets?api_key=0x12345'
        ...
        e_url = 'https://w4af.readthedocs.io/api/pets?limit=42&api_key=0x12345'
        e_headers = Headers([('Content-Type', 'application/json')])
...
class TestOpenAPINestedModelSpec(PluginTest):
    ...
    MOCK_RESPONSES = [HeaderAuthenticatedMockResponse('https://w4af.readthedocs.io/openapi.json',
                                                      NestedModel().get_specification(),
                                                      content_type='application/json'),

                      SQLIMockResponse(re.compile('https://w4af.readthedocs.io/api/pets.*'),
                                       body=None,
                                       method='GET',
                                       status=200)]
...
class TestOpenAPIRaisesWarningIfNoAuth(PluginTest):
    ...
    MOCK_RESPONSES = [MockResponse('https://w4af.readthedocs.io/openapi.json',
                                   NestedModel().get_specification(),
                                   content_type='application/json')]
...
class TestOpenAPIRaisesWarningIfParsingError(PluginTest):
    ...
    def test_parsing_error_raised(self):
        ...
        expected_desc = (
            'An Open API specification was found at: "https://w4af.readthedocs.io/openapi.json",'
            ...
            ' the parser were:\n'
            '\n'
            ' - The OpenAPI specification at https://w4af.readthedocs.io/openapi.json is not in'
            ' JSON or YAML format'
        )
...
class TestOpenAPIFindsSpecInOtherDirectory(PluginTest):
    ...
    MOCK_RESPONSES = [MockResponse('https://w4af.readthedocs.io/api/v2/openapi.json',
                                   NestedModel().get_specification(),
                                   content_type='application/json')]
...
class TestOpenAPIFindsSpecInOtherDirectory2(PluginTest):
    target_url = 'https://w4af.readthedocs.io/a/b/c/'
    ...
    MOCK_RESPONSES = [MockResponse('https://w4af.readthedocs.io/a/openapi.json',
                                   NestedModel().get_specification(),
                                   content_type='application/json')]
